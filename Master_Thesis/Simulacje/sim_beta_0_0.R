...
pdf(file = "b_0_0_iter_10_e-5_100sqrt.pdf")
ggplot() +
...
pdf(file = "b_0_0_iter_10_e-6_100sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_10_e-5_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_10_e-6_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_10_e-5_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_10_e-6_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-5_100sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-6_100sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-5_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-6_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-5_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_5_e-6_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-5_100sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-6_100sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-5_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-6_20sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-5_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_0_0_iter_1_e-6_50sqrt.pdf")
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
