...
pdf(file = "b_2_2_iter_10_e-5_100sqrt.pdf", height = 10, width = 10)
ggplot() +
...
pdf(file = "b_2_2_iter_10_e-6_100sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_10_e-5_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_10_e-6_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_10_e-5_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_10_e-6_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-5_100sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-6_100sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-5_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-6_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-5_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_5_e-6_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-5_100sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-6_100sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-5_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-6_20sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-5_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
...
pdf(file = "b_2_2_iter_1_e-6_50sqrt.pdf", height = 10, width = 10)
ggplot() +
  stat_contour(aes(x=outerCox$Var1,
                   y=outerCox$Var2,
                   z=outerCox$value),
