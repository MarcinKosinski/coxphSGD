...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{logitGD}\NormalTok{(mtcars$vs, mtcars$mpg, }\DataTypeTok{optim.method =} \StringTok{"GDI"}\NormalTok{, }\DataTypeTok{beta_0 =} \KeywordTok{c}\NormalTok{(-}\DecValTok{8}\NormalTok{,}\DecValTok{0}\NormalTok{),}
        \DataTypeTok{alpha=}\NormalTok{function(t)\{}\DecValTok{1}\NormalTok{/}\DecValTok{3}\NormalTok{\})$steps}
\KeywordTok{logitGD}\NormalTok{(mtcars$vs, dd, }\DataTypeTok{optim.method =} \StringTok{"GDII"}\NormalTok{,}
        \DataTypeTok{beta_0 =} \KeywordTok{c}\NormalTok{(}\FloatTok{0.43}\NormalTok{, -}\FloatTok{8.8}\NormalTok{))$steps}
\KeywordTok{logitGD}\NormalTok{(mtcars$vs[}\KeywordTok{sample}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(mtcars))],}
        \NormalTok{mtcars$mpg[}\KeywordTok{sample}\NormalTok{(}\KeywordTok{nrow}\NormalTok{(mtcars))],}
        \DataTypeTok{optim.method =} \StringTok{"SGDI"}\NormalTok{, }\DataTypeTok{eps=}\FloatTok{1e-7}\NormalTok{, }\DataTypeTok{beta_0 =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{),}
        \DataTypeTok{alpha=}\NormalTok{function(t)\{}\DecValTok{1}\NormalTok{/}\KeywordTok{nrow}\NormalTok{(mtcars)\})$steps}
\end{Highlighting}
\end{Shaded}
