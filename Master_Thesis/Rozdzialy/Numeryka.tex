...
%     \includegraphics[width=0.32\textwidth]{Obrazki/Rplot06.pdf}}
  ...
  %\vspace{-10pt}
  \label{fig:sc}
  \caption{Porównanie algorytmów spadku gradientu dla punktu startowego $\beta = (0,0)$.}
\end{figure}
...
%     \includegraphics[width=0.32\textwidth]{Obrazki/Rplot06.pdf}}
  ...
  %\vspace{-10pt}
  \label{fig:sc2}
  \caption{Porównanie algorytmów spadku gradientu dla punktu startowego $\beta = (1,2)$.}
\end{figure}
...
%     \includegraphics[width=0.32\textwidth]{Obrazki/Rplot06.pdf}}
  ...
  %\vspace{-10pt}
  \label{fig:sc3}
  \caption{Porównanie algorytmów spadku gradientu dla punktu startowego $\beta = (4,3)$.}
\end{figure}
...
%     \includegraphics[width=0.32\textwidth]{Obrazki/Rplot06.pdf}}
  ...
  %\vspace{-10pt}
  \label{fig:sc4}
  \caption{Porównanie algorytmów spadku gradientu dla punktu startowego $\beta = (3.1,2.1)$.}
\end{figure}
