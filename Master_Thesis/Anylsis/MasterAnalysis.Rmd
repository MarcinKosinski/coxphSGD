...
qplot(1:491,wspolczynniki[ ,which(colnames(wspolczynniki) == "CHRM2")]) +
  xlab('Krok algorytmu') +
  ylab('Wartość współczynnika') +
  theme_minimal(base_size = 20) +
  ggtitle('Wartości współczynnika genu CHRM2') -> fig6
qplot(1:491,wspolczynniki[ ,which(colnames(wspolczynniki) == "NDST4")]) +
xlab('Krok algorytmu') +
  ylab('Wartość współczynnika') +
  theme_minimal(base_size = 20) +
  ggtitle('Wartości współczynnika genu NDST4') -> fig7

saveToRepo(fig6) # d6b293f40d035fa66bdc9f43beffe45a
alink('d6b293f40d035fa66bdc9f43beffe45a', repo = 'coxphSGD', user = 'MarcinKosinski', format = 'latex')
saveToRepo(fig7) # 9ae2874f836ae8d1eb279e1dd158c04b
alink('9ae2874f836ae8d1eb279e1dd158c04b', repo = 'coxphSGD', user = 'MarcinKosinski', format = 'latex')
```
