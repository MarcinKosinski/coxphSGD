...
prepareForumlaSGD <- function(coxData){
  as.formula(paste("Surv(times, patient.vital_status) ~ ",
                   paste(names(coxData)[-c(1092, 1093)],
                         collapse="+"), collapse = ""))
}
...
```{r}
prepareForumlaSGD(coxData) -> formulaSGD
```
